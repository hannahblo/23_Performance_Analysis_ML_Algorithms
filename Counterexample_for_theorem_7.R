...
ufgs_1 <- enumerate_ufg_premises(whole_context=rbind(data_context_1,porder_rest_1), n_row_context=3)

# relevant ufg-premises for data set 1
ufgs_2 <- enumerate_ufg_premises(whole_context=rbind(data_context_2,porder_rest_2), n_row_context=3)
